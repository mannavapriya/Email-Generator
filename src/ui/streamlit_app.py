# -*- coding: utf-8 -*-
"""
Streamlit app for Email Assistant with internal JSON trace.
Displays per-agent execution steps during email generation.
"""
...
with col1:
    ...
    tone_choice = st.selectbox(
        "Tone (optional)", ["(profile)", "formal", "casual", "assertive"], index=0
    )
    ...
    if st.button("Generate email"):
        if not user_text:
            ...
            with spinner_placeholder.container():
                ...
                # Display JSON trace step by step
